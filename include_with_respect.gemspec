...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/include_with_respect/version.rb", mod) }::IncludeWithRespect::Error::Version::VERSION
  else
    ...
    IncludeWithRespect::Error::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/galtzo-floss/include_with_respect"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "http://github.com/pboling/include_with_respect"
