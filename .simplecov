# kettle-jem:freeze
# To retain chunks of comments & code during include_with_respect templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# include_with_respect will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
